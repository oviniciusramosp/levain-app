...
(() => {
  ...
  const T = {
    'pt-BR': {
      ...
      'how.s1d': 'Comece pelo curso estilo Duolingo. As aulas são curtas e práticas, com vídeos em cada etapa, embasadas na ciência e na experiência de padeiros de verdade.',
      ...
      'beyond.f1d': '27 aulas curtas em 5 módulos, com vídeos em cada etapa. Dos ingredientes e do fermento ao método e à solução de problemas, no estilo Duolingo.',
    ...
    es: {
      ...
      'how.s1d': 'Empieza por el curso al estilo Duolingo. Las lecciones son cortas y prácticas, con vídeos en cada etapa, basadas en la ciencia y en la experiencia de panaderos de verdad.',
      ...
      'beyond.f1d': '27 lecciones cortas en 5 módulos, con vídeos en cada etapa. Desde los ingredientes y el fermento hasta el método y la solución de problemas, al estilo Duolingo.',
